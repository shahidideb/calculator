...
var buttonm = document.querySelector("#buttonm");
var buttond = document.querySelector("#buttond");
var buttons = document.querySelector("#buttons");
var buttonh = document.querySelector("#buttonh");
...
buttonm.onclick  = addValue;
buttond.onclick  = addValue;
buttons.onclick  = addValue;
buttonh.onclick  = addValue;
buttona.onclick  = addValue;
buttoni.onclick  = addValue;
buttonx.onclick  = addValue;
buttony.onclick  = addValue;
